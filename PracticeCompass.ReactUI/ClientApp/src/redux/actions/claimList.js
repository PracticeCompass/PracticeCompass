            ...
            try {
                ...
                const resp = await axios({
                    ...
                    url: `${config.baseUrl}/ClaimList/ClaimGridGet?PatientID=${searchCriteria.PatientID
                        ...
                        }&IncludeCompletedClaims=${searchCriteria.completedClaims}&IncludeCashClaims=${searchCriteria.CashClaims}&IncludeVoidedClaims=${searchCriteria.VoidedClaims}
                        &Skip=${searchCriteria.Skip}&SortColumn=${searchCriteria.SortColumn ? searchCriteria.SortColumn : ""
