...
function mapDispatchToProps(dispatch) {
  return {
    ...
    getPatientPayments: (PracticeID, PatientID, DateType, Datevalue, Fullyapplied) => dispatch(getPatientPayments(PracticeID, PatientID, DateType, Datevalue, Fullyapplied)),
