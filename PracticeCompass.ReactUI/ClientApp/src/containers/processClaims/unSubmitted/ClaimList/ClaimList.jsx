  ...
  revertChange = async () => {
    if (this.state.currentFilter && this.state.currentFilter.body) {
      ...
      await this.setState({
        ...
        completedCalims: body.completedCalims,
      });
    } else {
      this.reset();
    }
  ...
  claimGridSearch = (refreshData = true) => {
    var claimGrid = {
      ...
      InsuranceOrder: this.state.insuranceOrder
        ...
        : "",
      completedCalims: this.state.completedCalims
        ? this.state.completedCalims
        : 0,
      ...
      <Fragment>
        ...
        >
          ...
          <div className="row nowrap rowHeight">
            ...
            <div>
              <CheckboxComponent
                label="Completed Calims"
                value={this.state.completedCalims}
                onChange={(e) => this.setState({ completedCalims: e.value })}
              />
            </div>
          </div>
