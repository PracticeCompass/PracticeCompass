...
select COUNT(*) OVER() as totalCount, PlanID as entitySID,CarrierCode,SortName,prrowid,Code as PlanCode from [Plan] where  (@sortname is null or @sortname='' or SortName like @sortname+'%' or CarrierCode  like @sortname+'%') 
order by SortName
