...
,@LastUser int,@CreateUser int,@CreateMethod varchar(2)

AS
BEGIN

Declare @TimeStamp varchar(50)='',@CreateStamp varchar(50)=''
if @PaymentSID=0
BEGIN
INSERT INTO [dbo].[Payment]
     ...
     VALUES
           (@prrowid,@PaymentSID,@PracticeID,@PostDate,@Source,@PayorID,@Class,@Amount,@Method,'N',@CreditCard,@AuthorizationCode
